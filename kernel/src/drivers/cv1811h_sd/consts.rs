...
pub const TOP_BASE: usize = 0x300_0000;
// pub const SD_DRIVER_ADDR: usize = 0xffff_ffc0_0431_0000;
pub const SD_DRIVER_ADDR: usize = 0x431_0000;
// pub const SOFT_REST_BASE_ADDR: usize = 0xffff_ffc0_0300_3000;
pub const SOFT_REST_BASE_ADDR: usize = 0x300_3000;
// pub const PINMUX_BASE: usize = 0xffff_ffc0_0300_1000;
pub const PINMUX_BASE: usize = 0x300_1000;
